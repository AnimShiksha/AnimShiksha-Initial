...
//         // http://127.0.0.1:5500/web/animvideo.html
    ...
    console.log()
        ...
        fill(255, 43, 4);
        nose.render(noseX,noseY-90,noseWidth+noseScaling,noseHeight+noseScaling);


        // mouth
        let mouthX = pose_.nose.x+upper;
        let mouthY = pose_.nose.y+sider;
        let mouthWidth = size-15;
        let mouthHeight = size -80;
        let mouthScaling = scaledDstnce/4
        mouthVid.render(mouthX, mouthY+40,mouthWidth+mouthScaling,mouthHeight+mouthScaling);
        ...
        eye.render(leftEyeX, leftEyeY-150, eyeHeight+eyeScaling, 0.1);
        eye.render(rightEyeX-30, rightEyeY-150, eyeHeight+eyeScaling, 0.1);
...
// ============================================================================================================
        ...
        tummy.render(tummyX-300,tummyY-250,tummyWidth+tummyScaling,tummyHeight+tummyScaling);
        ...
        line(leftShoulderX-300, rightShoulderY-250, leftElbowX, leftElbowY)
        line(rightShoulderX-300, rightShoulderY-250, rightElbowX, rightElbowY)
    }
}
